...
export default function App(){
 ...
 return <div className="shell">
  ...
  <main>
   ...
   {active==='editor'&&<EditorPanel project={project} file={file} setFile={setFile}/>} {active==='codebase'&&<IntelligencePanel index={index} health={health} project={project} aiConfig={aiConfig} openFile={path=>openFile(path,'editor')}/>}
