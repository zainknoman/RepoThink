...
export default function App(){
 ...
 const nav=[['overview','Overview'],['explorer','Explorer'],['search','Search'],['editor','Editor'],['codebase','Codebase'],['intelligence','Intelligence'],['architecture','Architecture'],['impact','Impact'],['health','Health'],['git','Git'],['context','Context'],['reports','Reports'],['ai','AI']];
 return <div className="shell">
  ...
  <main>
   ...
   {active==='intelligence'&&<IntelligencePanel index={index} health={health} project={project} aiConfig={aiConfig} openFile={path=>openFile(path,'editor')}/>}
